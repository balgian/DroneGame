...
#define RHO_OBST 5.0  // * Influence distance for repulsion
#define MIN_RHO_OBST 2.0 // * Minimum distance of repulsion
// * Targets' attractive force
#define EPSILON 3.0 // * Attractive scaling factor
#define RHO_TRG 5.0 // * Influence distance for attraction
#define MIN_RHO_TRG 2.0 // * Minimum distance of attraction
